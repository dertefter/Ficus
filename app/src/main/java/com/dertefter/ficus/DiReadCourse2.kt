...
class DiReadCourse2__ : AppCompatActivity() {
            ...
            withContext(Dispatchers.Main) {
                if (response.isSuccessful) {
                    try{
                        ...
                        if (doc.select("span.lock") != null && doc.select("span.lock").toString() != ""){
                            ...
                            val body = doc.select("div.nospaces.ulsortable").first()
                            if (body != null){
                                ...
                                for (i in items){
                                    ...
                                    if (attachments != null && attachments.size != 0){
                                        for (a in attachments){
                                            ...
                                            fileItem.findViewById<MaterialCardView>(R.id.file_card).setOnClickListener {
