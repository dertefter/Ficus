...
import kotlinx.android.synthetic.main.day_text.*
        ...
        if (img != "") {
            val transformation: Transformation =
                RoundedTransformationBuilder()
                    ...
                    .oval(false)
                    .build()
            Picasso.with(Ficus.applicationContext()).load(img).resize(200, 200).centerCrop()
                ...
                if (response.isSuccessful) {
                    ...
                    for (i in results){
                        ...
                        if (img != null){
                            ...
                            Picasso.with(Ficus.applicationContext()).load(profile_pic).resize(200, 200).centerCrop().transform(transformation).into(item.findViewById<ImageView>(R.id.profile_image))
                        }else{
